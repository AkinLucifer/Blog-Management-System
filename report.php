...
<div class="container">
    ...
    <form method="post" action="report_submit.php">
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Reasons to Report:</label>
                    <input type="text" name="username" value="<?php echo $username;?>" style="display: none;">
                    <input type="text" name="id" value="<?php echo $id;?>" style="display: none;">
                    <input type="text"  id="exampleFormControlTextarea1" name="reason" class="form-control">
                    <br>
                    <div class="d-grid gap-5 d-md-block">
                        <input  class="btn btn-success" type="submit" name="submit" value="Report">
